  ...
  return (
    <div className="mx-auto flex max-h-screen max-w-4xl flex-col gap-2 px-8 py-8">
      ...
      <p className="font-serif leading-8">
        ...
        . I like to do it to in my own garden at my computer. But how we do it
        when we do it for first time, how we can write 255 words for one blog?.
        I realize that, if i can do it it will be nice. I love to write
        everything here. Before I do this type of writing, i read a lot of
        article that makes me want to learn more about how to create myown
